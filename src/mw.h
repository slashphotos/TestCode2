...
#define  VERSION  211
#define  FIRMWARE  "HarakiriSG pre2.6 Test 1" __DATE__ " / " __TIME__
...
typedef struct config_t
{
    ...
    uint8_t  esc_gain;                      // [0-32] Gain for esc to reduce delay 16 = Gain of 1
...
extern float    INVACCDeltaTimeINS;
