...
- Added "esc_gain" [0 = Disable(default) .. 32] is is an implementation of Bob Doirons' idea: http://diydrones.com/profiles/blogs/arducopter-motor-response-compensation
-- THROTTLE_BOOST_KB is basically "esc_gain" but "16" = 1.0. I had very bad results with flashed ESC but unflashed ESC worked quiet well (better) with esc_gain = 8.
